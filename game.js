...
const games = [
  {
    ...
    kind: "внимательность",
    desc: "Найди рюкзак среди школьного хаоса.",
    accent: "#43b6ff",
  ...
  {
    id: "build",
    title: "Крылатый строитель",
    kind: "ловкость",
    desc: "Собери башню повыше.",
    accent: "#ff9f43",
  ...
  {
    id: "race",
    title: "Октаха лететь 220 в кювет",
    kind: "гонка",
    desc: "Шашки 40",
    accent: "#ffd84a",
  ...
  },
  {
    ...
    kind: "головоломка",
    desc: "Собирай одинаковые картинки в ряд.",
    accent: "#f865b0",
...
function makeAttractGame() {
  ...
  return {
    ...
    draw() {
      ...
      if (mobile) {
        drawImageFit(lenya, W / 2 - 120, 300, 120, 142, "bottom");
        drawImageFit(eva, W / 2 + 4, 300, 120, 142, "bottom");
      } else {
